...
syn keyword luaCond      if then elseif else end
syn keyword luaRepeat    while do repeat until
...
syn region luaBlock transparent matchgroup=luaStatement start="{" end="}" contains=ALLBUT,luaTodo,luaSpecial,luaCond,luaCondElseif,luaCondEnd,luaRepeat
